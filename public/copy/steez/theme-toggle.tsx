/**
 * Standalone Steez UI copy of Theme Toggle.
 *
 * Generated from packages/ui/src/components/ThemeToggle.tsx by pnpm registry:generate.
...
const __styles_steez_theme_toggle_0: Record<string, string> = {
  "themeToggle": "steez-theme-toggle-0-themeToggle",
  "iconButton": "steez-theme-toggle-0-iconButton",
};

const __steezStandaloneStyles = String.raw`/* packages/ui/src/components/ThemeToggle.module.css */
.steez-theme-toggle-0-themeToggle {
...
.steez-theme-toggle-0-themeToggle:hover {
  border-color: var(--interactive-secondary-border-hover, #cbcbcc);
  background: var(--interactive-secondary-bg-hover, #0f0f0f);
}

.steez-theme-toggle-0-iconButton {
  width: 2.25rem;
  height: 2.25rem;
}

`;
const __steezStandaloneStyleKey = "theme-toggle";
...
export function ThemeToggle({
  ...
  return (
    <button
      type="button"
      className={`${__styles_steez_theme_toggle_0.themeToggle} ${__styles_steez_theme_toggle_0.iconButton} ${className}`.trim()}
      onClick={toggleTheme}
