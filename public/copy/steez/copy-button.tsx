/**
 * Standalone Steez UI copy of Copy Button.
 *
 * Generated from packages/ui/src/components/CopyButton.tsx by pnpm registry:generate.
...
const __styles_steez_copy_button_0: Record<string, string> = {
  "copyButton": "steez-copy-button-0-copyButton",
  "copied": "steez-copy-button-0-copied",
  "error": "steez-copy-button-0-error",
  "visuallyHidden": "steez-copy-button-0-visuallyHidden",
};

const __steezStandaloneStyles = String.raw`/* packages/ui/src/components/CopyButton.module.css */
.steez-copy-button-0-copyButton {
  position: relative;
  display: inline-flex;
  align-items: center;
...
.steez-copy-button-0-copyButton:hover:not(:disabled) {
  border-color: var(--progress, #00ff9d);
  color: var(--progress, #00ff9d);
}

.steez-copy-button-0-copyButton:active {
  transform: scale(0.95);
}

.steez-copy-button-0-copied {
  border-color: var(--success, #00ff88);
  color: var(--success, #00ff88);
}

.steez-copy-button-0-error {
  border-color: var(--danger, #ee1401);
  color: var(--danger, #ee1401);
}

.steez-copy-button-0-visuallyHidden {
  position: absolute;
  width: 1px;
  height: 1px;
  padding: 0;
...
`;
const __steezStandaloneStyleKey = "copy-button";
...
export function CopyButton({
  ...
  return (
    <button
      type="button"
      className={`${__styles_steez_copy_button_0.copyButton} ${isCopied ? __styles_steez_copy_button_0.copied : ""} ${isError ? __styles_steez_copy_button_0.error : ""} ${className}`.trim()}
      onClick={handleCopy}
      title={nativeTitle}
      aria-label={accessibleLabel}
    >
      {isCopied ? <CheckIcon width={size} height={size} /> : <CopyIcon width={size} height={size} />}
      <span className={__styles_steez_copy_button_0.visuallyHidden} aria-live="polite">
