/**
 * Standalone Steez UI copy of Error Message.
 *
 * Generated from packages/ui/src/components/ErrorMessage.tsx by pnpm registry:generate.
...
const __styles_steez_error_message_0: Record<string, string> = {
  "primary": "steez-error-message-0-primary",
  "secondary": "steez-error-message-0-secondary",
  "danger": "steez-error-message-0-danger",
  "cyberpunk3": "steez-error-message-0-cyberpunk3",
  "cyberpunk6": "steez-error-message-0-cyberpunk6",
  "toolbarButton": "steez-error-message-0-toolbarButton",
  "small": "steez-error-message-0-small",
  "large": "steez-error-message-0-large",
};

const __styles_steez_error_message_1: Record<string, string> = {
  "card": "steez-error-message-1-card",
  "inline": "steez-error-message-1-inline",
  "fullScreen": "steez-error-message-1-fullScreen",
  "header": "steez-error-message-1-header",
  "message": "steez-error-message-1-message",
  "details": "steez-error-message-1-details",
  "actions": "steez-error-message-1-actions",
};

const __steezStandaloneStyles = String.raw`/* packages/ui/src/styles/Buttons.module.css */
.steez-error-message-0-primary,
.steez-error-message-0-secondary,
.steez-error-message-0-danger,
.steez-error-message-0-cyberpunk3,
.steez-error-message-0-cyberpunk6 {
  position: relative;
  display: inline-flex;
  align-items: center;
...
.steez-error-message-0-primary:hover:not(:disabled) {
...
.steez-error-message-0-toolbarButton:hover:not(:disabled) {
  background: var(--interactive-primary-bg, #cbcbcc);
  border-color: var(--interactive-primary-border, #cbcbcc);
  color: var(--interactive-primary-fg, #010607);
}
...
.steez-error-message-0-danger:hover:not(:disabled) {
...
.steez-error-message-0-cyberpunk3::before {
  content: "";
  position: absolute;
  top: calc(100% + 1px);
  right: 0;
...
.steez-error-message-0-cyberpunk3::after {
  content: "";
  position: absolute;
  top: calc(100% + 1px);
  right: 32%;
...
.steez-error-message-0-cyberpunk3:hover:not(:disabled) {
  color: color-mix(in srgb, var(--accent-primary, #ee1401) 84%, var(--text-primary, #cbcbcc));
}

.steez-error-message-0-cyberpunk3:hover:not(:disabled)::before {
  width: 66%;
}

.steez-error-message-0-cyberpunk3:hover:not(:disabled)::after {
  right: 66%;
}
...
.steez-error-message-0-cyberpunk6::before {
  content: "";
  position: absolute;
  top: -2px;
  left: 100%;
...
.steez-error-message-0-cyberpunk6::after {
  content: "";
  position: absolute;
  top: -2px;
...
.steez-error-message-0-cyberpunk6:hover:not(:disabled) {
  background: currentColor;
  color: var(--text-on-accent, #010607);
}

.steez-error-message-0-cyberpunk6:hover:not(:disabled)::before {
  background: currentColor;
}

.steez-error-message-0-cyberpunk6:hover:not(:disabled)::after {
  left: calc(100% + 1.55rem);
  border-right-width: 0.95rem;
}

.steez-error-message-0-small {
  padding: 4px 10px;
  font-size: 0.75rem;
}

.steez-error-message-0-large {
  padding: 12px 24px;
  font-size: 1rem;
}

.steez-error-message-0-primary:disabled,
.steez-error-message-0-secondary:disabled,
.steez-error-message-0-toolbarButton:disabled,
.steez-error-message-0-danger:disabled,
.steez-error-message-0-cyberpunk3:disabled,
.steez-error-message-0-cyberpunk6:disabled {
  opacity: 0.5;
  cursor: not-allowed;
}


/* packages/ui/src/components/ErrorMessage.module.css */
.steez-error-message-1-card {
  background: color-mix(in srgb, var(--bg-secondary, #0a0a0a) 90%, transparent);
  border: 1px solid var(--danger, #ee1401);
...
.steez-error-message-1-inline {
  display: flex;
  flex-direction: column;
  gap: 0.5rem;
  padding: 1rem;
  background: var(--danger-bg, rgba(238, 20, 1, 0.15));
  border-left: 4px solid var(--danger, #ee1401);
  margin: 0.5rem 0;
}

.steez-error-message-1-fullScreen {
  position: fixed;
  inset: 0;
  display: flex;
  align-items: center;
  justify-content: center;
  background: rgba(1, 6, 7, 0.8);
  z-index: 999;
}

.steez-error-message-1-header {
  display: flex;
  align-items: center;
  gap: 0.5rem;
  color: var(--danger, #ee1401);
...
.steez-error-message-1-header h3 {
  margin: 0;
  font-size: 1.1rem;
}

.steez-error-message-1-message {
  color: var(--text-primary, #cbcbcc);
  margin: 0 0 1rem 0;
  line-height: 1.5;
}

.steez-error-message-1-details {
  margin: 1rem 0;
  padding: 0.5rem;
...
.steez-error-message-1-details summary {
  cursor: pointer;
  color: var(--text-secondary, #999999);
  margin-bottom: 0.5rem;
}

.steez-error-message-1-details pre {
  margin: 0;
  overflow-x: auto;
...
`;
const __steezStandaloneStyleKey = "error-message";
...
export const ErrorMessage = React.memo(function ErrorMessage({
  ...
  const content = (
    <>
      <div className={__styles_steez_error_message_1.header}>
        <WarningIcon width={24} height={24} />
        <h3>{title}</h3>
      </div>
      <p className={__styles_steez_error_message_1.message}>{message}</p>
      {details ? (
        <details className={__styles_steez_error_message_1.details}>
          <summary>Details</summary>
          <pre>{details}</pre>
        </details>
      ) : null}
      {onRetry || onDismiss ? (
        <div className={__styles_steez_error_message_1.actions}>
          {onRetry ? (
            <button type="button" onClick={onRetry} className={__styles_steez_error_message_0.secondary}>
          ...
          {onDismiss ? (
            <button type="button" onClick={onDismiss} className={__styles_steez_error_message_0.secondary}>
  ...
  if (variant === "fullScreen") {
    return (
      <div className={__styles_steez_error_message_1.fullScreen} role="alert" aria-live="assertive">
        <div className={__styles_steez_error_message_1.card}>{content}</div>
      </div>
    );
  }
  ...
  if (variant === "inline") {
    return (
      <div className={__styles_steez_error_message_1.inline} role="alert" aria-live="assertive">
        {content}
      </div>
    );
  }
  ...
  return (
    <div className={__styles_steez_error_message_1.card} role="alert" aria-live="assertive">
      {content}
    </div>
  );
});
