/**
 * Standalone Steez UI copy of Page Header.
 *
 * Generated from packages/ui/src/components/PageHeader.tsx by pnpm registry:generate.
...
const __styles_steez_page_header_0: Record<string, string> = {
  "header": "steez-page-header-0-header",
  "headerRow": "steez-page-header-0-headerRow",
  "brandCluster": "steez-page-header-0-brandCluster",
  "brandButton": "steez-page-header-0-brandButton",
  "brandVisual": "steez-page-header-0-brandVisual",
  "headerContent": "steez-page-header-0-headerContent",
  "titleIcon": "steez-page-header-0-titleIcon",
  "headerExtra": "steez-page-header-0-headerExtra",
  "iconButton": "steez-page-header-0-iconButton",
};

const __steezStandaloneStyles = String.raw`/* packages/ui/src/components/PageHeader.module.css */
.steez-page-header-0-header {
  padding: 16px 24px;
  background: var(--bg-secondary, #0a0a0a);
}

.steez-page-header-0-headerRow {
  display: flex;
  align-items: center;
  gap: 12px;
}

.steez-page-header-0-brandCluster {
  display: flex;
  align-items: center;
  gap: 12px;
}

.steez-page-header-0-brandButton {
  border: none;
...
.steez-page-header-0-brandButton:focus-visible {
  outline: 2px solid var(--color-border-hover, #3a3a3a);
  outline-offset: 2px;
  border-radius: 6px;
}

.steez-page-header-0-brandVisual {
  height: 48px;
  width: 48px;
  display: inline-flex;
  align-items: center;
...
.steez-page-header-0-headerContent {
  line-height: normal;
}

.steez-page-header-0-headerContent h2 {
  margin: 0;
  font-size: 32px;
  font-weight: 400;
...
.steez-page-header-0-titleIcon {
  display: inline-flex;
  margin-right: 8px;
  vertical-align: middle;
}

.steez-page-header-0-headerContent p {
  margin: 0;
  font-size: 14px;
  color: var(--color-text-secondary, #999999);
}

.steez-page-header-0-headerExtra {
  margin-left: auto;
  display: flex;
  align-items: center;
  gap: 8px;
...
.steez-page-header-0-iconButton {
  border: none;
  background: transparent;
  padding: 8px;
  margin: 0;
...
.steez-page-header-0-iconButton:hover {
  color: var(--color-text-primary, #cbcbcc);
}

.steez-page-header-0-iconButton:focus-visible {
  outline: 2px solid var(--color-border-hover, #3a3a3a);
  outline-offset: 2px;
  border-radius: 4px;
}
...
`;
const __steezStandaloneStyleKey = "page-header";
...
export function PageHeader({
  ...
  return (
    <div className={`${__styles_steez_page_header_0.header} ${className}`.trim()}>
      <div className={__styles_steez_page_header_0.headerRow}>
        <div className={__styles_steez_page_header_0.brandCluster}>
          {brand || onBrandClick ? (
            <button
              type="button"
              className={__styles_steez_page_header_0.brandButton}
              onClick={onBrandClick}
              title={brandTitle}
              aria-label={brandAriaLabel}
            >
              <span className={__styles_steez_page_header_0.brandVisual}>{brand ?? title.slice(0, 1)}</span>
            </button>
          ) : null}
          <div className={__styles_steez_page_header_0.headerContent}>
            <h2>
              {icon ? (
                <span className={__styles_steez_page_header_0.titleIcon}>
        ...
        <div className={__styles_steez_page_header_0.headerExtra}>
          {extra}
          {onBack ? (
            <button type="button" className={__styles_steez_page_header_0.iconButton} onClick={onBack} aria-label="Go back">
              <Icon icon="chevronLeft" width={18} height={18} />
            </button>
          ) : null}
          {onSettings ? (
            <button type="button" className={__styles_steez_page_header_0.iconButton} onClick={onSettings} aria-label="Open settings">
          ...
          {onViewerToggle ? (
            <button
              type="button"
              className={__styles_steez_page_header_0.iconButton}
